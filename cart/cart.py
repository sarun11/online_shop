...
class Cart(object):
    ...
    def get_cart_products(self):    
        ...
        # get the product objects and add then to the cart
    ...
    def get_shipping_cost(self):
        product_quantity = sum([item["quantity"] for item in self.cart.values()])
        
        # return get_book_shipping_cost(product_quantity)
        return 0
